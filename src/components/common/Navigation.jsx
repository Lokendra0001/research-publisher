...
export default function Navigation() {
    ...
    { label: "Past Issues", href: "/issues/past" },
    {
      ...
      dropdownItems: [
        ...
        { label: "Plagiarism Policy", href: "/guidelines/plagiarism-policy" },
        {
          ...
          href: "/guidelines/publication-charges",
        },
      ],
    },
  ...
  return (
    <nav
      className={`${navBgClass} border-t border-orange-700/20 shadow-md sticky top-0 z-40 transition-colors duration-300`}
    >
      <div className="max-w-7xl mx-auto px-4 relative">
        <ul className="hidden lg:flex flex-wrap items-center ">
          {currentLinks.map((link, index) => (
            <li
              key={index}
              className={`relative group ${index !== currentLinks.length - 1 ? "border-r border-orange-400/30" : ""}`}
      ...
      >
        <div
          className={`/95 backdrop-blur-sm border-t border-white/10 shadow-lg rounded-b-lg`}
        >
