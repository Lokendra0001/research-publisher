    ...
    <div className="space-y-6 w-full  mx-auto grid grid-cols-1 md:grid-cols-2 md:gap-5 lg:gap-0 lg:grid-cols-1 ">
      ...
      <div className="border-2 border-primary bg-primary-foreground shadow-sm">
        ...
        <div className="p-8 text-center">
          <span className="text-[12px] font-black text-text-primary/80">
      ...
      <div className="border-2 border-primary bg-primary-foreground shadow-sm">
        ...
        <div className="p-0">
          <Link
            href="/guidelines/copyright-form"
            className="flex items-center gap-2 px-4 py-3 border-b text-gray-700 hover:bg-gray-50 font-medium"
          >
