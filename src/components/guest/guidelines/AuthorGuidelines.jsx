  ...
  return (
    <section className="space-y-3 mt-15">
      <CommonGuide
        data={{
          ...
          blocks: [
            {
              type: "paragraph",
         text: `"Authors should include their full details on the title page. The editorial team will remove all identifying information before sending the manuscript for peer review."`
            },
            {
      ...
      <div className="space-y-6">
        <ul>
          <li className="ml-8 lg:ml-20 list-disc font-bold  my-2">
            Format for Journal Paper
          </li>
          <p className="pl-10 lg:pl-25 text-text-primary leading-relaxed font-medium">
            Syntax: &lt;First character of name & First character of Middle
            name&gt;. &lt;Surname&gt;, “title of paper”, Journal Name, Vol.
            X(Issue/No), pp.&lt;Page no&gt;, &lt;Year&gt;. Example: S. K.
            Sharma, L. Gupta, “A Novel Approach for Cloud Computing
            Environment”, International Journal of Computer Sciences and
            Engineering, Vol. 4, Issue.,12, pp.1-5, 2014.
          </p>
        </ul>
        <ul>
          <li className="ml-8 lg:ml-20 list-disc font-bold  my-2">
          ...
          <p className="pl-10 lg:pl-25 text-text-primary leading-relaxed font-medium">
            Syntax: &lt;First character of name & First character of Middle
            name&gt;. &lt;Surname&gt;, “title of book”, &lt;Publisher Name&gt;,
            &lt;Publisher location&gt;, pp.&lt;page no&gt;, &lt;Year&gt;.
            Example: K. Gupta, “A Proposed New Approach for Cloud Environment
            using Cryptic rules”, ISROSET Publisher, India, pp. 542-545, 2016.
          </p>
        </ul>
        <ul>
          <li className="ml-8 lg:ml-20 list-disc font-bold  my-2">
          ...
          <p className="pl-10 lg:pl-25 text-text-primary leading-relaxed font-medium">
            Syntax: &lt;First character of name & First character of Middle
            name&gt;. &lt;Surname&gt;, “&lt;title of Paper&gt;”, &lt;Conference
            title or name&gt;, &lt;Conference location (country)&gt;,
            pp.&lt;page no&gt;, &lt;Year&gt;. Example: S.L. Mewada, “A Proposed
            New Approach for Cloud Environment using Cryptic Techniques” In the
            Proceedings of the 2016 International Conference on Computer Science
            and Engineering, India, pp.542-545, 2016.
          </p>
        </ul>

        <ul className="pl-8 lg:pl-25 list-disc  space-y-2 font-medium">
          <li>
            Invalid (websites URL) references remove or replaced by Journal
            references.
          </li>
        ...
        <div>
          <h3 className="text-xl text-primary-blue font-bold  my-6">
            Author Biographies
          </h3>
          <p className="text-text-primary leading-relaxed font-medium">
            IJARMY is now Publishing Biographies with Photographs of authors at
            the conclusion of every published article. For every author on a
            given paper, it is required that a biography no longer than 100
            words be included at the end of the paper. Author biographies should
            be ordered according to the order of authors on the paper. For
            Example: Mr. C T Lin pursed B.Tech., M.Tech., and Ph.D. Physical
            Science from IIT, Bombay in 1998, 2002 & 2008. He is currently
            working as Professor in Department of Physical Science from IIT,
            Bombay since 2010. He is a member of IEEE & IEEE computer society
            since 2013, Life member of ACM since 2011 and a life member of the
            IJARMY since 2015. He has published more than 50 research papers in
            reputed international journals including Thomson Reuters (SCI & Web
            of Science) and conferences including IEEE and it’s also available
            online. His main research work focuses on Cryptography Algorithms,
            Network Security, Cloud Security and Privacy, Big Data Analytics,
            Data Mining, IoT and Computational Intelligence based education. He
            has 15 years of teaching experience and 10 years of research
            experience.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-text-primary leading-relaxed font-medium">
            Copyright of all accepted papers will belong to IJARMY and the
            author(s) must affirm that accepted Papers for publication in IJARMY
            must not be re-published elsewhere without the written consent of
            the editor. To comply with this policy, authors will be required to
            submit a signed copy of Copyright Transfer Form, available at
            Download Section ,after acceptance of their paper, before the same
            is published
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-text-primary leading-relaxed font-medium">
            ...
            corresponding author or a link will be provided in the e-mail so
            that the authors can download the files themselves. These PDF proofs
            can be annotated; for this you need to download Adobe Reader version
            ...
            . If authors do not wish to use the PDF annotations function, they
            may list the corrections and return them to IJARMY in an e-mail.
            Please list corrections quoting line number. If, for any reason,
            this is not possible, then mark the corrections and any other
            comments on a printout of the proof and then scan the pages having
            corrections and e-mail them back, within 05 days. Please use this
            proof only for checking the typesetting, editing, completeness and
            correctness of the text, tables and figures. Significant changes to
            the paper that has been accepted for publication will not be
            considered at this stage without prior permission. It is important
            to ensure that all corrections are sent back to us in one
            communication: please check carefully before replying, as inclusion
            of any subsequent corrections cannot be guaranteed. Proofreading is
            solely authors’ responsibility. Note that IJARMY will proceed with
            the publication of paper, if no response is received within 05 days
