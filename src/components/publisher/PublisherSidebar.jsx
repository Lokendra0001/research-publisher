...
const PublisherSidebar = () => {
    ...
    const sidebarLinks = [
        ...
        { label: "Approve Reviewers", page: "approve_reviewers", icon: CheckSquare },
        { label: "New Submissions", page: "new_submissions", icon: Send },
        { label: "Rejected Invitations", page: "rejected_invitations", icon: XCircle },
        ...
        { label: "Issued Certificate List", page: "issued_certificate_list", icon: Award },
    ];
            ...
            <nav className="flex flex-col py-1">
                {sidebarLinks.map((link, index) => {
                    ...
                    return (
                        ...
                        >
                            <link.icon className={`w-4 h-4 ${isActive ? "text-secondary" : "text-text-primary/50"}`} />
                            {link.label}
                        </Link>
                    );
                })}
