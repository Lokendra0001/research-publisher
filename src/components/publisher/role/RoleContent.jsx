...
const RoleContent = () => {
  ...
  const renderContent = () => {
    switch (page) {
      case "home_content":
        return <HomeContent title="Home Page Content" />;
      case "approve_reviewers":
        return <ApproveReviewers />;
      case "new_submissions":
        return <NewSubmissions />;
      case "rejected_invitations":
      ...
      case "issued_certificate_list":
        return <ListissueCertificate title="Issued Certificate List" />;
      case "refundable":
        return <Refundable />;
      default:
        return <ApproveReviewers />;
