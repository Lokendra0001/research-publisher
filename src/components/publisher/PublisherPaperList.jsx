...
const PublisherPaperList = ({
  ...
  const filteredAssignments = assignments.filter(
    (item) =>
      ...
      (item.paper?.id &&
        item.paper.id.toLowerCase().includes(filter.toLowerCase())),
  );
      ...
      <div className="overflow-x-auto border border-border scrollbar-hidden">
        <table className="w-full text-sm text-left text-text-primary/50 ">
          <thead className="text-xs text-text-primary/70 uppercase bg-muted/50 border-b border-border">
            <tr>
              <th scope="col" className="px-6 py-3 font-bold w-14">
                No.
              </th>
              <th
                scope="col"
              ...
              <th scope="col" className="px-6 py-3 font-bold min-w-[152px]">
                {dateHeader}
              </th>
              ...
              <th
                scope="col"
                className="px-6 py-3 font-bold min-w-[152px] text-center"
              >
                More Details
              </th>
            </tr>
