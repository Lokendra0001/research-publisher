      ...
      <div className="overflow-x-auto border border-border scrollbar-hidden">
        <table className="w-full text-sm text-left text-text-primary/50">
          <thead className="text-xs text-text-primary/70 uppercase bg-muted/50 border-b border-border">
            <tr>
              <th scope="col" className="px-6 py-3 font-bold w-10">
                No.
              </th>
              <th
                scope="col"
                className="px-6 py-3 font-bold min-w-38 md:min-w-38"
              >
                Paper Details
              </th>
              <th
                scope="col"
                className="px-6 py-3 font-bold min-w-40 lg:min-w-auto"
              >
                Declined By
              </th>
              <th
              ...
              <th
                scope="col"
                className="px-6 py-3 font-bold min-w-40 md:w-64 text-center"
              >
                Reassign
              </th>
            </tr>
              ...
              {filteredAssignments.map((assignment, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 align-top">
                    <p
                      className="text-text-primary font-semibold mb-1 line-clamp-2"
                    ...
                    <p className="text-xs text-mono text-text-primary/50">
                      ID:{" "}
                      {assignment.paper?.customId ||
                        assignment.paper?.id?.slice(0, 8)}
                    </p>
                  </td>
                  <td className="px-6 py-4 align-top">
                  ...
                  <td className="px-6 py-4 align-top">
                    <div className="flex flex-col gap-2">
                      <select
                        ...
                        onChange={(e) =>
                          handleReviewerSelect(assignment.id, e.target.value)
                        }
                      >
