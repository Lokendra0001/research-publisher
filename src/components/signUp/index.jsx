          ...
          <div className="flex justify-start ">
            <div className="flex space-x-1">
              <button
                ...
                className={`px-8 py-2.5 font-bold text-sm rounded-t-md border-t border-l border-r transition-colors ${
                  role === "author"
          ...
          <div className="border border-border rounded-tl-none rounded-sm">
            ...
            <div className="bg-border/50 px-3 md:px-4 py-3 border-b border-border border-dotted mb-4">
              <h2 className="text-lg font-bold text-text-primary/70">
                <span className="capitalize">{role}</span> Registration Form{" "}
                      ...
                      <div className="bg-border/50 p-4 rounded-sm">
                        ...
                        <textarea
                          {...register("researchInterests", {
                            required: "Research Interests are required",
                          })}
                          rows={3}
