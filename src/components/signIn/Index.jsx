...
const SignIn = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto md:px-4 py-8 font-sans">
            <h1 className="text-3xl font-bold text-primary-blue mb-6">Sign Up / Login</h1>
                    ...
                    <div className="border border-border rounded-sm">
                        ...
                        <div className="bg-border/50 px-4 py-3 border-b border-border border-dotted mb-4">
                            <h2 className="text-lg font-bold text-text-primary/70">
                                Log In Form <span className="text-danger text-sm font-normal">(*Required)</span>
                            </h2>
                        </div>
                        ...
                        <div className="px-3 md:px-6 pb-6 pt-2">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        <Link href="/forgot-password" className="text-primary-blue/90 hover:text-primary-blue hover:underline text-sm font-bold">
                                            Forgot Password?
                                        </Link>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 pt-2">
                                        ...
                                        <div className="text-sm text-gray-700">
                                            New User? <Link href="/signup" className="text-primary-blue/70 hover:text-primary-blue hover:underline font-bold">Click Here</Link>
                                        </div>
                                    </div>
                                </div>
                            </form>
